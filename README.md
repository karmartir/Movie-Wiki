...
- **Movie Details:** View details including title, year, poster, IMDb rating, and more.
- **Watched List:** Add movies to your watched list, rate them, and keep track of what you've seen.
...
2. **View Details:** Click a movie to see its details and ratings.
3. **Add to Watched:** Mark a movie as watched, optionally rate it, and it will appear in your watched list.
4. **Manage Watched List:** See your watched movies, their ratings, and remove any if needed.
